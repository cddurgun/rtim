  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 p-4">
      ...
      <Link href="/" className="flex items-center space-x-2 mb-8">
        ...
        <span className="text-2xl font-bold">RTIM</span>
      </Link>
        ...
        <CardContent>
          ...
          <div className="mb-6 space-y-2">
            <div className="flex items-start space-x-2 text-sm">
              ...
              <span className="text-gray-600 dark:text-gray-300">100 free credits to start</span>
            </div>
            <div className="flex items-start space-x-2 text-sm">
              <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-gray-600 dark:text-gray-300">AI-powered video generation</span>
            </div>
            <div className="flex items-start space-x-2 text-sm">
              <CheckCircle2 className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-gray-600 dark:text-gray-300">Intelligent prompt enhancement</span>
            </div>
          </div>
      ...
      <Link
        href="/"
        className="mt-6 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
      >
        ← Back to home
      </Link>
    </div>
